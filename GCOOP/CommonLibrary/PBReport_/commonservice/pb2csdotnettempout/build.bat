...
if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.common.xml"   /platform:x86  /linkres:bin\commonservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.common.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.common.xml"   /platform:x86  /linkres:bin\commonservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.common.dll" *.cs > "%~2"
)
...
:end
xcopy /D /Y "bin\pbservice.common.dll" install\
