...
namespace CommonLibrary.WsCommon {
    using System;
    ...
    public partial class Common : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Common() {
            this.Url = global::CommonLibrary.Properties.Settings.Default.CommonLibrary_WsCommon_Common;
        ...
        public System.Data.DataTable GetBranchId(string wsPass, string csType) {
        ...
        /// <remarks/>
        public void GetBranchIdAsync(string wsPass, string csType) {
            this.GetBranchIdAsync(wsPass, csType, null);
        }
        
        /// <remarks/>
        public void GetBranchIdAsync(string wsPass, string csType, object userState) {
            ...
            this.InvokeAsync("GetBranchId", new object[] {
                        wsPass,
                        csType}, this.GetBranchIdOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void VerifyLoginAsync(string wsPass, string username, string password, string application, string branchId) {
            this.VerifyLoginAsync(wsPass, username, password, application, branchId, null);
        }
        
        /// <remarks/>
        public void VerifyLoginAsync(string wsPass, string username, string password, string application, string branchId, object userState) {
            ...
            this.InvokeAsync("VerifyLogin", new object[] {
                        ...
                        password,
                        application,
                        branchId}, this.VerifyLoginOperationCompleted, userState);
        }
