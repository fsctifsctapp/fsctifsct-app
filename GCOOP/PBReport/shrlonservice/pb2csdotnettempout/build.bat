...
xcopy /D /Y "c:\gcoop\pbservice\shrlonservice\shrlonservice.pbd" bin\

xcopy /D /Y "c:\gcoop\pbservice\shrlonservice\shrlonservice.pbd" install\


if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.shrlon.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\shrlonservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.shrlon.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.shrlon.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\shrlonservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.shrlon.dll" *.cs > "%~2"
)
...
if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.shrlon.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\shrlonservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.shrlon.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.shrlon.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\shrlonservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.shrlon.dll" *.cs > "%~2"
)
...
:end
xcopy /D /Y "bin\pbservice.shrlon.dll" install\
