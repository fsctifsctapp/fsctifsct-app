...
xcopy /D /Y "d:\gcoop\pbservice\commonservice\commonservice.pbd" bin\

xcopy /D /Y "d:\gcoop\pbservice\commonservice\commonservice.pbd" install\

xcopy /D /Y "d:\gcoop\pbservice\accountservice\accountservice.pbd" bin\

xcopy /D /Y "d:\gcoop\pbservice\accountservice\accountservice.pbd" install\


if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.accountservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\accountservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.accountservice.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.accountservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\accountservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.accountservice.dll" *.cs > "%~2"
)
...
if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.accountservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\accountservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.accountservice.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.accountservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\accountservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.accountservice.dll" *.cs > "%~2"
)
...
:end
xcopy /D /Y "bin\pbservice.accountservice.dll" install\
