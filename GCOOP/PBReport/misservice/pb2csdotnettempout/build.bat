...
xcopy /D /Y "c:\users\9lordofart\desktop\cat\program\pbservice\commonservice\commonservice.pbd" bin\

xcopy /D /Y "c:\users\9lordofart\desktop\cat\program\pbservice\commonservice\commonservice.pbd" install\

xcopy /D /Y "c:\users\9lordofart\desktop\cat\program\pbservice\misservice\misservice.pbd" bin\

xcopy /D /Y "c:\users\9lordofart\desktop\cat\program\pbservice\misservice\misservice.pbd" install\


if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.misservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\misservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.misservice.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.misservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\misservice.pbd "/r:%PBNET_HOME%\bin\Sybase.PowerBuilder.Core.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Interop.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Common.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.Win.dll;%PBNET_HOME%\bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;%PBNET_HOME%\bin\com.sybase.ejb.net.dll;%PBNET_HOME%\bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.misservice.dll" *.cs > "%~2"
)
...
if "%~2" == "" (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.misservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\misservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.misservice.dll" *.cs
) else (
%NET_FRAMEWORK_PB$PBVERSION$%\csc /t:library /debug /nowarn:1591 /doc:"bin\pbservice.misservice.xml"   /platform:x86  /linkres:bin\commonservice.pbd /linkres:bin\misservice.pbd "/r:bin\Sybase.PowerBuilder.Core.dll;bin\Sybase.PowerBuilder.Interop.dll;bin\Sybase.PowerBuilder.Common.dll;bin\Sybase.PowerBuilder.Win.dll;bin\Sybase.PowerBuilder.DataWindow.Win.dll;bin\Sybase.PowerBuilder.WinWebDataWindowCommon.dll;bin\com.sybase.ejb.net.dll;bin\com.sybase.iiop.net.dll" /out:"bin\pbservice.misservice.dll" *.cs > "%~2"
)
...
:end
xcopy /D /Y "bin\pbservice.misservice.dll" install\
