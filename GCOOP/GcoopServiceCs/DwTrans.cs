...
namespace GcoopServiceCs
{
    public class DwTrans : Sybase.DataWindow.Transaction
    {
        ...
        public DwTrans(String connectionString)
            : base(new System.ComponentModel.Container())
        {
            try
            {
                this.connectionString = connectionString;// new System.Web.UI.Page().Session["ss_connectionstring"].ToString(); // System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
