...
{
    public partial class w_sheer_wc_trn_member_status : PageWebSheet, WebSheet
    {
        ...
        public void SaveWebSheet()
        {
            ...
            //    result = WsUtil.Walfare.TrnMemb_ChgBranch_confirm(state.SsWsPass, state.SsApplication, XmlMain, "w_sheet_wc_trn_memb.pbl", state.SsUsername, state.SsCsType, state.SsWorkDate, 0);
        ...
        public void WebSheetLoadEnd()
        {
            ...
            try
            {
                ...
                DwUtil.RetrieveDataWindow(DwMain, "w_sheet_wc_trn_memb.pbl", null, cstype);
