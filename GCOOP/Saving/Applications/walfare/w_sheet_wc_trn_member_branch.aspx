...
CodeBehind="w_sheet_wc_trn_member_branch.aspx.cs" Inherits="Saving.Applications.walfare.w_sheet_wc_trn_member_branch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwOption" runat="server" DataWindowObject="d_wc_trn_option_new"
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_trn_memb_new"
        LibraryList="~/DataWindow/walfare/w_sheet_wc_trn_memb.pbl" ClientScriptable="True"
        AutoSaveDataCacheAfterRetrieve="True" AutoRestoreDataCache="True" ClientEventItemChanged="OnDwMainItemChanged"
        AutoRestoreContext="False" ClientFormatting="True" TabIndex="200">
    </dw:WebDataWindowControl>
     <br />
     <dw:WebDataWindowControl ID="DwIn" runat="server" DataWindowObject="d_wc_trn_in_new"
        LibraryList="~/DataWindow/walfare/w_sheet_wc_trn_memb.pbl" ClientScriptable="True"
        AutoSaveDataCacheAfterRetrieve="True" AutoRestoreDataCache="True" ClientEventItemChanged="OnDwInItemChanged"
        AutoRestoreContext="False" ClientFormatting="True" TabIndex="200" >
    </dw:WebDataWindowControl>
