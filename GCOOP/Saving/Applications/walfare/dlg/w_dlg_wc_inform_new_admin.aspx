<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_wc_inform_new_admin.aspx.cs" 
Inherits="Saving.Applications.walfare.dlg.w_dlg_wc_inform_new_admin" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectRow(sender, rowNumber, objectName) {
            var deptaccount_no = objDwList.GetItem(rowNumber, "deptaccount_no");
            parent.setAccnoNew(deptaccount_no);
            parent.RemoveIFrame();
        }
...
<body>
    ...
    <div align="center">
        ...
        <br /> <br />
        <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_wc_inform_new_search_detail"
