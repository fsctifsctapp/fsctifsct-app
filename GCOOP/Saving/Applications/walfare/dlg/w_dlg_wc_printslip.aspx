<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_wc_printslip.aspx.cs" Inherits="Saving.Applications.walfare.dlg.w_dlg_wc_printslip" %>
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwMain_org" runat="server" DataWindowObject="d_wc_slip_payment_reg_"
        ...
        <dw:WebDataWindowControl ID="DwMain_coppy" runat="server" DataWindowObject="d_wc_slip_payment_reg_"
            LibraryList="~/DataWindow/walfare/w_sheet_wc_walfare_new.pbl" ClientEventClicked="selectRow"
            ClientScriptable="True" RowsPerPage="12" HorizontalScrollBar="Auto" VerticalScrollBar="Auto"
            AutoRestoreContext="False" AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True"
            ClientFormatting="True" ClientEventItemChanged="OnDwMainItemChanged" >
