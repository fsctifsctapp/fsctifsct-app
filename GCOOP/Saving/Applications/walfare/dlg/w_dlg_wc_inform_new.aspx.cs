...
{
    public partial class w_dlg_wc_inform_new : PageWebDialog, WebDialog
    {
        ...
        private void JsShowlist()
        {
            ...
            try
            {
                ...
                if (SQLcon == "")
                {
                    SQL = SQLBegin + " and wcdeptmaster.branch_id = '" + state.SsBranchId + "'";
                }
                else
                {
                    SQL = SQLBegin + SQLcon + " and wcdeptmaster.branch_id = '" + state.SsBranchId + "' ORDER BY wcdeptmaster.deptaccount_no ASC";
                }
