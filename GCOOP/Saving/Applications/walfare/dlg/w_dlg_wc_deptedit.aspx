<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_wc_deptedit.aspx.cs" Inherits="Saving.Applications.walfare.dlg.w_dlg_wc_deptedit" %>
...
<body>
    ...
    <div align="center">
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_master_search"
            LibraryList="~/DataWindow/walfare/w_sheet_wc_membermaster.pbl" ClientScriptable="True" AutoRestoreContext="False"
        ...
        <br /> <br />
        <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_wc_master_search_detail"
            LibraryList="~/DataWindow/walfare/w_sheet_wc_membermaster.pbl" ClientEventClicked="selectRow"
