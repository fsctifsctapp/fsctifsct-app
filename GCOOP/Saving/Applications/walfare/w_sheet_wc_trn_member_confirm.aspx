...
CodeBehind="w_sheet_wc_trn_member_confirm.aspx.cs" Inherits="Saving.Applications.walfare.w_sheet_wc_trn_member_confirm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwOption" runat="server" DataWindowObject="d_wc_trn_admin_option"
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_trn_admin_confirm"
        LibraryList="~/DataWindow/walfare/w_sheet_wc_trn_memb.pbl" ClientScriptable="True"
