...
{
    public partial class w_sheet_wc_criteria_search_for_member : PageWebSheet, WebSheet
    {
        ...
        {/*
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        string membNO;
                        if ((state.SsCsType == "6" && DwMain.GetItemString(1, "wftype_code") == "02") || (state.SsCsType == "1" && DwMain.GetItemString(1, "wftype_code") == "03") || (state.SsCsType == "8" && DwMain.GetItemString(1, "wftype_code") == "03") || (state.SsCsType == "8" && DwMain.GetItemString(1, "wftype_code") == "05") || (state.SsCsType == "8" && DwMain.GetItemString(1, "wftype_code") == "06"))
                        {
