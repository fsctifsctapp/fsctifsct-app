...
{
    public partial class w_sheet_wc_inform_adminn : PageWebSheet, WebSheet
    {
            ...
            if (HdStatus.Value == "1")
            {
                try
                {
                    ...
                    if (HdModeSave.Value != "edit")
                    {
                        ...
                        {
                            String resignChg = DwMain.GetItemString(1, "resigncause_code");
                            if (resignChg == "02")
                            {
                                String Xmldiem = Dwdiem.Describe("DataWindow.data.XML");
                                String member_no = DwMain.GetItemString(1, "member_no").Trim();
                                String deptaccount_no = DwMain.GetItemString(1, "deptaccount_no").Trim();
                                String branch_id_in = DwMain.GetItemString(1, "branch_id");

                                result1 = WsUtil.Walfare.infrom_die_mm_save(state.SsWsPass, state.SsApplication, Xmldiem, "w_sheet_wc_inform.pbl", state.SsUsername, state.SsCsType, member_no, deptaccount_no, branch_id_in, resignChg);
                                //if (result1)
                                //{
                                //    Dwdiem.Reset();
                                //}
                            ...
                            if (result == 1)
                            {
                                ...
                                Dwdiem.SetItemDecimal(1,"pay_flag",3);
                                Dwdiem.SetItemDecimal(1, "die_age", 0);
                            }
                            else
                            {
        ...
        private void Initinform()
        {
            ...
            try
            {
                ...
                if (result == 0)
                {
                    ...
                    a.deptaccount_no='" + deptaccount_no + @"'";
                    ...
                    if (dt.Next())
                    {
                        ...
                        DwMain.SetItemString(1, "branch_id", branch_id);
        ...
        private void setYearMonth(String resignChg)
        {
            if (Dwdiem.RowCount < 1)
            {
                Dwdiem.InsertRow(0);
                string Syear = Convert.ToString(DateTime.Today.Year + 543);
                Dwdiem.SetItemString(1, "for_year", Syear);
            }
            if (resignChg == "01")
            {
                Dwdiem.Modify("t_3.Visible=0");
                Dwdiem.Modify("die_age.Visible=0");
                Dwdiem.Modify("t_4.Visible=0");
            }
            else
            {
                Dwdiem.Modify("t_3.Visible=1");
                Dwdiem.Modify("die_age.Visible=1");
                Dwdiem.Modify("t_4.Visible=1");
            }
        }
        ...
        private int Saveinform(string SaveMode)
        {
            ...
            try
            {
                ...
                String branch_idd = DwMain.GetItemString(1, "branch_id");
                ...
                if (SaveMode != "edit")
                {
                    ...
                    sql = sql + "" + 8 + ",'" + member_no + "'," + quantitymem_amt + "," + cremateestpay_amt + ",'" + wftype_code + "'," + die_status + ",'" + branch_idd + "'," + withdrawable_amt + "," + wfe_amt + "," + wfe_amt2 + ")";
                ...
                else
                {
                    ...
                    '" + regchg_docno_old + @"' and branch_id = '" + branch_idd + "'";
                ...
                for_year = Dwdiem.GetItemString(1, "for_year");
                sele_mon = Dwdiem.GetItemString(1, "sele_mon");
                pay_flag = Dwdiem.GetItemDecimal(1, "pay_flag");
                ...
                SQLmem_close = @"INSERT INTO WCMEMBERCLOSE (DPREQCHG_DOC,
                                                            DEPTACCOUNT_NO,
                                                            CLOSE_FLAG,
                                                            PAY_FLAG,
                                                            RESIGNCAUSE_CODE,
                                                            ...
                                                            CS_TYPE)
                                                    VALUES ('" + ReqchgNo + @"',
                                                            '" + WebUtil.MemberNoFormat(deptaccount_no) + @"',
                                                            8,
                                                            '" + pay_flag + @"',
                                                            '" + die_code + @"',
                                                            '" + for_year + @"',
