...
CodeBehind="w_sheet_wc_add_feeyear.aspx.cs" Inherits="Saving.Applications.walfare.w_sheet_wc_add_feeyear" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwOption" runat="server" DataWindowObject="d_wc_feeyearlast_add_option"
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_feeyearlast_add"
        LibraryList="~/DataWindow/walfare/w_sheet_wc_walfare_paid.pbl" ClientScriptable="True"
