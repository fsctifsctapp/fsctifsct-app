...
CodeBehind="w_sheet_wc_find_req.aspx.cs" Inherits="Saving.Applications.walfare.w_sheet_wc_find_req" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwCri" runat="server" DataWindowObject="d_wc_chkother_cs_search"
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_find_req_detail"
