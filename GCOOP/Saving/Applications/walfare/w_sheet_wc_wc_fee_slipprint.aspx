<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_wc_wc_fee_slipprint.aspx.cs" Inherits="Saving.Applications.walfare.w_sheet_wc_wc_fee_slipprint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DWCtrl" runat="server" DataWindowObject="d_wc_fee_slipprint_main"
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_wc_fee_slipprint_detail"
        LibraryList="~/DataWindow/walfare/w_sheet_wc_walfare_slip.pbl" ClientScriptable="True"
