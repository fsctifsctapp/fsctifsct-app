<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_wc_transfer_all.aspx.cs"
    Inherits="Saving.Criteria.u_cri_wc_transfer_all" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_wc_transfer_all"
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td align="left" style="width: 100px;">
                            <asp:LinkButton ID="LinkBackk" runat="server">&lt; ย้อนกลับ</asp:LinkButton>
                        </td>
                        <td>
                            &nbsp;
                        </td>
