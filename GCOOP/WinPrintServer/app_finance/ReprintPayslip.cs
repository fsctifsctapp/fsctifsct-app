...
{
    public class ReprintPayslip : WinPrintInterface
    {
        ...
        {
            String as_message = "";
            returnWebService = Convert.ToString(fin.of_postreprintpayslip(as_branch, adtm_wdate, as_list_xml, as_formset, ref as_message));
            return "REPRINTPAYSLIP";
        }
