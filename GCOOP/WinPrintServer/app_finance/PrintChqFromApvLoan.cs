...
{
    public class PrintChqFromApvLoan : WinPrintInterface
    {
        ...
        {
            returnWebService = Convert.ToString(fin.of_postpaychq_fromapvloan(as_branch, as_entry, adtm_wdate, as_machine, as_cond_xml, as_bankcut_xml, as_chqtype_xml, as_chqlist_xml, as_formset));
            return "FIN PRINTCHQFROMAPVLOAN";
        }
    }
}
